const JAVA_SILVER_1Z0_815_JPN_06 = {
    prefix: "1Z0-815-JPN_06",
    questions: [
        {
            id: 1,
        ...
        },
        {
            ...
            code: "",
            choices: [
                "<pre><code>Void sample() { }</code></pre>",
                '<pre><code>void sample() { return "sample"; }</code></pre>',
                "<pre><code>sample() { }</code></pre>",
                '<pre><code>int sample() { return "sample"; }</code></pre>',
                "<pre><code>void sample() { }</code></pre>",
            ],
            answerIndex: 4,
            explanation:
        ...
        },
        {
            ...
            choices: [
                "<pre><code>int calc(int a) {}</pre></code>",
                "<pre><code>double calc(double a, int b) {}</pre></code>",
                "<pre><code>int calc(double a, double b) {}</pre></code>",
                "<pre><code>int calc(double num1, int num2) {}</pre></code>",
                "<pre><code>int calc() {}</pre></code>",
                "<pre><code>int calc(int a, double b) {}</pre></code>",
            ],
            answerIndex: [1, 3],
            explanation:
