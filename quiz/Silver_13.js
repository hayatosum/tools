    ...
    questions: [
        ...
        },
        {
            ...
            choices: [
                ...
                "<code>System.out.println(s.header + Sample.getValue());</code>",
                "<code>System.out.println(Sample.header + s.getValue());</code>",
        ...
        },
        {
            ...
            choices: [
                ...
                "<code>public int calculate() { return num * 2; }</code>",
                "<code>public abstract int getNum() { return num; }</code>",
                "<code>public abstract int test();</code>",
                "<code>public static void sample() { // some codes }</code>",
            ],
            answerIndex: 1,
