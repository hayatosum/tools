const SILVER_02 = {
  ...
  "questions": [
    ...
    },
    {
      ...
      "answerIndex": 4,
      "explanation": "a は var により A 型として推論され、最後に C 型を代入し test() を呼ぶと C が表示される。"
    },
    {
      "id": 9,
      "question": "Stringオブジェクトを作成するコードとして、正しいものを選びなさい。（2つ選択）",
      "choices": [
      ...
      "answerIndex": [0, 1],
      "explanation": "Stringのインスタンス生成はnewまたはリテラル。newInstanceは存在せず、valueOfは単一のchar/intなど。"
    },
    {
      "id": 10,
      "question": "次のプログラムをコンパイル、実行したときの結果として、正しいものを選びなさい。（1つ選択）",
      ...
      "answerIndex": 0,
      "explanation": "Stringはimmutable。replaceAllの結果を再代入していないため元の文字列のまま出力される。"
    },
    {
      "id": 11,
      "question": "次のプログラムをコンパイル、実行したときの結果として、正しいものを選びなさい。（1つ選択）",
    ...
    {
      "id": 17,
      "question": "次のプログラムを実行し、「Hello, Java!」と表示したい。3行目の空欄に入るコードとして、正しいものを選びなさい。（1つ選択）",
      "code": "public class Sample {\n    public static void main(String[] args) {\n        String str = _____;\n        System.out.println(str);\n    }\n}",
      "choices": [
        "\"Hello, \".concat(\"Java!\")",
        "\"Hello, \".append(\"Java!\")",
    ...
    },
    {
      ...
      "answerIndex": 3,
      "explanation": "reverseで \"edcba\"、replace(1,3,\"a\")で \"ea ba\" → \"eaba\" だが誤記に注意。実際は \"eaba\"。"
    },
    {
      "id": 22,
      "question": "次のプログラムをコンパイル、実行したときの結果として、正しいものを選びなさい。（1つ選択）",
