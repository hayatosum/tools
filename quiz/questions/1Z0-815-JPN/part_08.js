const Q_1Z0_815_JPN_08 = {
    ...
    questions: [
        ...
        },
        {
            ...
            answerIndex: [1, 2],
            explanation:
                "Javaのラムダ式では、波括弧を使う場合はreturn文が必須です。値だけを記述しても何も返されず文法エラーとなります。また、波括弧なしでreturn文を記述することもできません。式だけを返す場合は波括弧もreturnも不要です。引数が1つの場合は括弧を省略することもできますが、いずれの場合も構文ルールに従う必要があります。",
        },
        {
            id: 3,
            category: "関数型インタフェース、ラムダ式",
